...
namespace prm
{
    spring_line::spring_line(const glm::vec2 &p1,
                             const glm::vec2 &p2,
    ...
    const glm::vec2 &spring_line::p1() const { return m_p1; }
    const glm::vec2 &spring_line::p2() const { return m_p2; }

    const sf::Color &spring_line::color() const { return m_color; }
    void spring_line::color(const sf::Color &c) { m_color = c; }

    void spring_line::p1(const glm::vec2 &p1) { m_p1 = p1; }
    void spring_line::p2(const glm::vec2 &p2) { m_p2 = p2; }
