...
{
  public:
    spring_line(const glm::vec2 &p1, const glm::vec2 &p2, const sf::Color &color = sf::Color::White);
  ...
  private:
    ...
    float m_supports_length = 8.f, m_left_padding = 0.f, m_right_padding = 0.f, m_min_height = 10.f;
