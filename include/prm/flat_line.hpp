...
{
  public:
    flat_line(const glm::vec2 &p1, const glm::vec2 &p2, const sf::Color &color1, const sf::Color &color2);

    flat_line(const glm::vec2 &p1, const glm::vec2 &p2, const sf::Color &color = sf::Color::White);
